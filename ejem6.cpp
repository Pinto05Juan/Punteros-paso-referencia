...
int main() {
  ...
  while (1) {
		...
		printf("2. Escribir la matriz\n");
		printf("3. Sumar las matrices\n");
		printf("4. Multiplicar las matrices\n");
		printf("5. Calcular la determinante\n");
		printf("6. Calcular la transpuesta\n");
		printf("7. Salir\n");
		printf("Seleccione una entre estas opciones disponibles(1-7): ");
		scanf("%d", &opcion);

		switch (opcion) {
		  case 1:
	      printf("Ingrese el numero de filas y columnas para lamatriz 1: ");
	      scanf("%d %d", &filas1, &columnas1);
	      cargarMatriz(matriz1, filas1, columnas1);
	      printf("Ingrese el numero de filas y columnas para matriz 2: ");
          ...
          printf("Las matrices no tienen las mismas dimensiones, no es posible sumarlas.\n");
	      }
	      break;
		  case 4:
	      if (columnas1 == filas2) {
          ...
          printf("Las matrices no tienen las dimensiones correctas para multiplicarlas.\n");
	      }
	      break;
		  case 5:
	      if (filas1 == columnas1) {
          ...
          printf("La matriz 1 no es cuadrada, por lo cual no se puede hacer la determinante\n");
	      }
	      break;
		  case 6:
